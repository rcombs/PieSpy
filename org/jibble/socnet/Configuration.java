...
public class Configuration implements java.io.Serializable {
    ...
    public Configuration(Properties p) throws NoSuchElementException {
        ...
        try{
            createJSON = getBoolean("CreateJSON");
            createImages = getBoolean("CreateImages");
        }catch(Exception e){
            createJSON = true;
            createImages = true;
        }
        ...
        ignoreChannels = getSet("IgnoreChannels");
        ...
        nodeThreshold = getDouble("NodeThreshold");
